...
AI full-stack app builder (React/TypeScript) with chat + editor, DB/Auth, deployment, image-generation. Verify current pricing.

## Overview

**Lovable** is a hosted generator of a whole application in the *AI app / UI / full-stack builders* category, made by Lovable.

Founders prototyping SaaS products quickly.
...
Great default stack (React/TS/CSS), deploy + auth + DB included.

Known limitations: Proprietary; UI-agent/builder rather than an editor agent.
...
- [Official install/setup docs](https://lovable.dev/)
...
Proprietary; UI-agent/builder rather than an editor agent.
...
- Developers who need stability guarantees — Lovable changes quickly; re-verify features and pricing before committing.
