...
ByteDance's cloud IDE + AI agent (chat/agent/autocomplete) with VS Code compatibility; verify current FREE tier and region availability.

## Overview

**MarsCode** is a hosted generator of a whole application in the *AI app / UI / full-stack builders* category, made by ByteDance.

Free cloud IDE + agent with VS Code compatibility.

## Official Links

- [Official website](https://www.marscode.com/)
...
Cloud IDE, agent chat + autocomplete, low-entry-cost.

Known limitations: Region/data-locality concerns; closed source.
...
Free/usage-metric-based (site-dependent).
...
- [Official install/setup docs](https://www.marscode.com/)
...
Region/data-locality concerns; closed source.
...
- Developers who need stability guarantees — MarsCode changes quickly; re-verify features and pricing before committing.
...
Works well on this machine for normal use. Stated requirements: Browser-based..
