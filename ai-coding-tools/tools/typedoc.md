...
TypeScript documentation generator from .ts source.

## Overview

**TypeDoc** is a generates documentation from source code or api specifications. in the *Documentation generation / platform tools* category, made by Open source.

TypeScript/TSX APIs.

## Official Links

- [Official website](https://typedoc.org/)
...
Great TS type reflection.

Known limitations: TS only.
...
- [Official install/setup docs](https://typedoc.org/)
...
- Developers who need stability guarantees — TypeDoc changes quickly; re-verify features and pricing before committing.
...
- [Source repository](https://github.com/TypeStrong/TypeDoc)
