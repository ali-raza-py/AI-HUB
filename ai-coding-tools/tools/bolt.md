...
AI web/app builder running the full stack in the browser (WebContainers); auto model routing; Bolt Cloud adds backend (verified Sep 2026).

## Overview

**Bolt.new** is a hosted generator of a whole application in the *AI app / UI / full-stack builders* category, made by StackBlitz.

Rapid full-stack prototypes; modern front-end builds.
...
In-browser execution, Figma import, Bolt Cloud backends.

Known limitations: Proprietary; costs jump with heavy usage tokens.
...
Free tier; Pro/Max with bigger token limits.
...
- [Official install/setup docs](https://bolt.new/)
...
Proprietary; costs jump with heavy usage tokens.
...
- Developers who need stability guarantees — Bolt.new changes quickly; re-verify features and pricing before committing.
