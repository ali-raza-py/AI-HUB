...
**SWE-ReX** is a terminal agent (cli/repl) in the *Terminal / CLI coding agents* category, made by BAAI Research.

Research comparison; SWE-bench style autonomous solving.
...
Open research implementation by BAAI.

Known limitations: Activity to verify.
...
- Developers who need stability guarantees — SWE-ReX changes quickly; re-verify features and pricing before committing.
