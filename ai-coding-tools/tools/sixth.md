...
> Last verified: 2026-09 · Status: unknown · Autonomy: Level 0 — see [the autonomy scale](../docs/autonomy-scale.md).

Not verified — check official documentation before using.

## Overview

**Sixth** is a editor/ide native agent (vs code extension host) in the *VS Code / IDE AI agents* category, made by Unknown.
...
- Developers who need stability guarantees — Sixth changes quickly; re-verify features and pricing before committing.
