...
Hosted API documentation platform with interactive requests, MCP support, and AI features.

## Overview

**ReadMe** is a api reference generation, publishing, and developer portals. in the *Documentation generation / platform tools* category, made by ReadMe.

API-first products needing interactive reference docs.
...
Interactive API explorers, versioning, enterprise SSO.

Known limitations: Hosted; code-reference depth varies.
...
Paid plans; free tier for some use cases.
...
- [Official install/setup docs](https://docs.readme.com)
...
Hosted; code-reference depth varies.
...
- Developers who need stability guarantees — ReadMe changes quickly; re-verify features and pricing before committing.
...
- [Official website](https://readme.com/)
- [Official documentation](https://docs.readme.com)
