...
Factory's autonomous software engineer product ('Droid'). Enterprise agent-native development focus; verify current availability/pricing.

## Overview

**Factory Droid** is a cloud-hosted autonomous agent in the *Autonomous software-engineering agents* category, made by Factory.

Enterprise engineering orgs running autonomous agents at scale.
...
Autonomous, cloud, covers the SDLC loop.

Known limitations: Enterprise focus; costly; not a student tool.
...
- [Official install/setup docs](https://www.factory.ai/)
...
Enterprise focus; costly; not a student tool.
...
- Developers who need stability guarantees — Factory Droid changes quickly; re-verify features and pricing before committing.
...
Enterprise focus; costly; not a student tool. Stated requirements: None (cloud)..
