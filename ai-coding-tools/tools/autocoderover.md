...
**AutoCodeRover** is a research prototype agent in the *Autonomous software-engineering agents* category, made by SMU / Yale / UIUC researchers.

Research and SWE-bench-style experiments.
...
Strong published evaluation results.

Known limitations: Academic tooling; not a polished product.
...
Academic tooling; not a polished product.
...
- Developers who need stability guarantees — AutoCodeRover changes quickly; re-verify features and pricing before committing.
