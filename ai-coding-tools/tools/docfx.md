...
Open-source .NET documentation generator.

## Overview

**DocFX** is a generates documentation from source code or api specifications. in the *Documentation generation / platform tools* category, made by .NET Foundation / Microsoft (open source).

.NET API reference plus markdown conceptual docs.

## Official Links

- [Official website](https://dotnet.github.io/docfx/)
...
Reads .NET XML doc comments; markdown pipeline; templates.

Known limitations: .NET-centric; no AI features.
...
Free and open source; static-site output you host.
...
- [Official install/setup docs](https://dotnet.github.io/docfx/)
...
- Developers who need stability guarantees — DocFX changes quickly; re-verify features and pricing before committing.
...
- [Source repository](https://github.com/dotnet/docfx)
