...
JavaScript documentation generator from JSDoc comments.

## Overview

**JSDoc** is a generates documentation from source code or api specifications. in the *Documentation generation / platform tools* category, made by Open source.
...
Known limitations: Weak type awareness; TS projects prefer TypeDoc.
...
- [Official install/setup docs](https://jsdoc.app/)
...
Weak type awareness; TS projects prefer TypeDoc.
...
- Developers who need stability guarantees — JSDoc changes quickly; re-verify features and pricing before committing.
...
- [Source repository](https://github.com/jsdoc/jsdoc)
