...
Cognition announced acquisition of Windsurf on 2025-07-14 (official blog, verified). Windsurf continued operating as a product under Cognition; Devin (Cognition's autonomous agent) integrates with Windsurf. Check windsurf.com for current state.

## Overview

**Windsurf** is a standalone ai ide (fork of vs code / code oss) in the *VS Code / IDE AI agents* category, made by Windsurf (ex-Codeium); acquired by Cognition in 2025.

Developers who like a Cursor-style agentic IDE with a strong Cascade/agent model.
...
Agentic 'Cascade', good context engine, MCP, IDE focus.

Known limitations: Closed source; ownership changed twice in ~18 months (Codeium to Windsurf to Cognition).
...
- [Official install/setup docs](https://windsurf.com/)
...
Closed source; ownership changed twice in ~18 months (Codeium to Windsurf to Cognition).
...
- Developers who need stability guarantees — Windsurf changes quickly; re-verify features and pricing before committing.
...
Works well on this machine for normal use. Stated requirements: Similar to Cursor..
