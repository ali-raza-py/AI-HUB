...
**Mentat** is a terminal agent (cli/repl) in the *Terminal / CLI coding agents* category, made by Mentat (abante.ai).

Historical study of CLI editing agents.
...
Simple CLI editing approach.

Known limitations: Activity/status uncertain — verify.
...
- [Official install/setup docs](https://github.com/AbanteAI/mentat)
...
Activity/status uncertain — verify.
...
- Developers who need stability guarantees — Mentat changes quickly; re-verify features and pricing before committing.
