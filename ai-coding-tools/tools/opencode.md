...
TUI, LSP, MCP, session control, BYOK.

Known limitations: Archived; use Crush instead.
...
- Developers who need stability guarantees — OpenCode changes quickly; re-verify features and pricing before committing.
