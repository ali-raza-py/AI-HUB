...
Free-software Python API doc generator.

## Overview

**pdoc** is a generates documentation from source code or api specifications. in the *Documentation generation / platform tools* category, made by pdoc maintainers (open source).

Python API reference generated directly from docstrings.

## Official Links

- [Official website](https://pdoc.dev/)
- Documentation — not verified, check official website
- [GitHub](https://github.com/mitmproxy/pdoc)
...
Lightweight, zero-config defaults, live-reload preview.

Known limitations: Python only; no AI features; minimal theming.
...
Free and open source; no hosted product.
...
- [Official install/setup docs](https://pdoc.dev/)
...
Python only; no AI features; minimal theming.
...
- Developers who need stability guarantees — pdoc changes quickly; re-verify features and pricing before committing.
...
- [Source repository](https://github.com/mitmproxy/pdoc)
