...
Open-source OpenAPI renderer (redoc) + Redocly paid platform.

## Overview

**Redoc** is a api reference generation, publishing, and developer portals. in the *Documentation generation / platform tools* category, made by Redocly.

Beautiful interactive API references from OpenAPI.

## Official Links

- [Official website](https://redocly.com/)
...
Great rendering; easy to embed.

Known limitations: API-centric only.
...
redoc is open source; Redocly is paid.
...
- [Official install/setup docs](https://redocly.com/)
...
- Developers who need stability guarantees — Redoc changes quickly; re-verify features and pricing before committing.
...
- [Source repository](https://github.com/Redocly/redoc)
