...
**Fern** is a api reference generation, publishing, and developer portals. in the *Documentation generation / platform tools* category, made by Fern.

API companies wanting docs + typed SDKs from one OpenAPI source.
...
One source (OpenAPI) -> docs + SDKs, code-native.

Known limitations: Setup complexity for non-API products.
...
- [Official install/setup docs](https://buildwithfern.com/)
...
Setup complexity for non-API products.
...
- Developers who need stability guarantees — Fern changes quickly; re-verify features and pricing before committing.
