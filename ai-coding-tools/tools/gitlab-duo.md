...
GitLab Duo is a proprietary product feature. GitLab the platform is open-core, which does not make Duo open source.

## Overview

**GitLab Duo** is a ide plugin + agent workspace in the *VS Code / IDE AI agents* category, made by GitLab.

GitLab-hosted teams wanting AI across MR/issue/CI lifecycle.

## Official Links

- [Official website](https://about.gitlab.com/gitlab-duo/)
...
Deep GitLab integration, agent platform, governance, model selection.

Known limitations: Requires GitLab subscription; not a standalone tool.
...
Required Premium/Ultimate plan additions; credit-based usage.
...
- Open source: **False**
- License: **Proprietary (GitLab itself is open-core)**
...
- [Official install/setup docs](https://about.gitlab.com/gitlab-duo/)
...
Requires GitLab subscription; not a standalone tool.
...
- Developers who need stability guarantees — GitLab Duo changes quickly; re-verify features and pricing before committing.
