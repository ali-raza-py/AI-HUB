...
Agentic development platform with Context Engine, Cosmos orchestration, CLI; oriented at org-scale SDLC (verified Sep 2026).

## Overview

**Augment Code** is a editor/ide native agent (vs code extension host) in the *VS Code / IDE AI agents* category, made by Augment Code, Inc..

Teams that want code-review, incident, ticket-to-PR automation agents.
...
Context engine, cosmo orchestration, code review and security-remediation loops.

Known limitations: Enterprise-oriented; not a student/budget tool.
...
Commercial; paid plan (pricing page).
...
- [Official install/setup docs](https://www.augmentcode.com/)
...
Enterprise-oriented; not a student/budget tool.
...
- Developers who need stability guarantees — Augment Code changes quickly; re-verify features and pricing before committing.
...
Enterprise-oriented; not a student/budget tool. Stated requirements: Cloud agent; any machine..
