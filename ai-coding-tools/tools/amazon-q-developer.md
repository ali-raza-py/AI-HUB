...
AWS agentic coding assistant (successor to CodeWhisperer); VS Code/JetBrains extensions plus the Amazon Q CLI. Verify current AWS pricing tiers before use.

## Overview

**Amazon Q Developer** is a ide plugin + agent workspace in the *VS Code / IDE AI agents* category, made by AWS.

Developers already in the AWS ecosystem who want an IDE agent with AWS-aware guidance.
...
Deep AWS integration, IDE + CLI + agent workflows, free tier.

Known limitations: Proprietary; value drops sharply outside AWS projects; limits change.
...
Free tier for individual use plus paid Pro tier — verify the current limits on AWS pricing.
...
- [Official install/setup docs](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/what-is.html)
...
Proprietary; value drops sharply outside AWS projects; limits change.
...
- Developers who need stability guarantees — Amazon Q Developer changes quickly; re-verify features and pricing before committing.
...
Works well on this machine for normal use. Stated requirements: Runs with VS Code or JetBrains IDEs..
...
- [Official website](https://aws.amazon.com/q/developer/)
- [Official documentation](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/what-is.html)
