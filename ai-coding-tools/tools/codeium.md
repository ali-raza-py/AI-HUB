...
> Last verified: 2026-09 · Status: renamed · Autonomy: Level 3 — see [the autonomy scale](../docs/autonomy-scale.md).

Codeium was renamed to Windsurf in 2024-2025; product continues under the Windsurf brand.

## Overview

**Codeium** is a autocomplete-focused assistant in the *VS Code / IDE AI agents* category, made by Windsurf (formerly Codeium).

Historical; users should evaluate Windsurf.
...
Fast completions, chat, some agent features.

Known limitations: Rebranded into Windsurf; treat Codeium name as legacy.
...
Free tier; paid plans under Windsurf brand.
...
Rebranded into Windsurf; treat Codeium name as legacy.
...
- Developers who need stability guarantees — Codeium changes quickly; re-verify features and pricing before committing.
