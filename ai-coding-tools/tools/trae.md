...
Free AI IDE (VS Code fork) with plug-in ecosystem; supported models vary by region. Verify current details.

## Overview

**Trae** is a standalone ai ide (fork of vs code / code oss) in the *VS Code / IDE AI agents* category, made by ByteDance.

Free Cursor alternative if available in your region.
...
Free, integrates many models, agent workflow.

Known limitations: Closed source; regional availability and data handling to verify.
...
Free tier; premium features later.
...
- [Official install/setup docs](https://www.trae.ai/)
...
Closed source; regional availability and data handling to verify.
...
- Developers who need stability guarantees — Trae changes quickly; re-verify features and pricing before committing.
